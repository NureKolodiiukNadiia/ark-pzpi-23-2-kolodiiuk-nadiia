...
public static class DataSeed
{
    public static void Seed(IServiceProvider serviceProvider)
    {
        ...
        //     var context = provider.GetRequiredService<SpotRentDbContext>();
        ...
        //             new Space
        //             {
        //                 Name = "Conference Room", Description = "Large conference room", SpaceType = SpaceType.ConferenceRoom,
        //                 Capacity = 10, HourlyRate = 50m, IsAvailable = true, CreatedAt = DateTime.UtcNow
        //             },
        //             new Space
        //             {
        //                 Name = "Open Desk", Description = "Open workspace area", SpaceType = SpaceType.Desk, Capacity = 20,
        //                 HourlyRate = 20m, IsAvailable = true, CreatedAt = DateTime.UtcNow
        //             },
        //             new Space
        //             {
        //                 Name = "Private Office", Description = "Private office for teams",
        //                 SpaceType = SpaceType.PrivateOffice, Capacity = 5, HourlyRate = 80m, IsAvailable = true,
        ...
        //                 TotalAmount = spaces[0].HourlyRate * 2, Duration = Duration.Hourly,
        //                 CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow
        //             },
        //             new Booking
        //             {
        ...
        //                 TotalAmount = spaces[1].HourlyRate * 2, Duration = Duration.Hourly,
        //                 CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow
        //             },
        //             new Booking
        //             {
        ...
        //                 TotalAmount = spaces[2].HourlyRate * 2, Duration = Duration.Hourly,
        //                 CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow
        //             }
        //         };
